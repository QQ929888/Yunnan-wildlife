export default class LineElement extends Element<import("basic.js").AnyObject, import("basic.js").AnyObject> {
    static id: string;
    /**
     * @type {any}
     */
    ...
    _path: any;
    _points: any;
    _segments: import("helpers.segment.js").Segment[];
    _decimated: boolean;
    ...
    set points(arg: any);
    get points(): any;
    get segments(): import("helpers.segment.js").Segment[];
    /**
