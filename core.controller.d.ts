...
declare class Chart {
    ...
    chartArea: any;
    _active: any[];
    _lastEvent: import("index.js").ChartEvent;
    _listeners: {};
     ...
     * @pravate
     */
    _getActiveElements(e: ChartEvent, lastActive: import('index.js').ActiveElement[], inChartArea: boolean, useFinalPosition: boolean): import('index.js').ActiveElement[];
}
