import type { Chart, Point, FontSpec, CanvasFontSpec, PointStyle, RenderTextOpts } from 'index.js';
import type { TRBL, SplinePoint, RoundedRect, TRBLCorners } from 'geometric.js';
/**
