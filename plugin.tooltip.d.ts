export class Tooltip extends Element<import("basic.js").AnyObject, import("basic.js").AnyObject> {
    /**
    ...
    dataPoints: {
        ...
        dataIndex: number;
        datasetIndex: number;
        element: Element<import("basic.js").AnyObject, import("basic.js").AnyObject>;
    }[];
    title: any;
    beforeBody: any;
    body: any[];
...
export type Chart = import('platform.base.js').Chart;
export type ChartEvent = import('index.js').ChartEvent;
export type ActiveElement = import('index.js').ActiveElement;
export type InteractionItem = import('core.interaction.js').InteractionItem;
...
import { noop } from "helpers.core.js";
